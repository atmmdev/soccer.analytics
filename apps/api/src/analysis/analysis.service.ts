    ...
    const result = this.analysisEngine.analyze(
      {
        ...
        avgShots: homeTeamStats.avgShots,
        avgShotsOnTarget: homeTeamStats.avgShotsOnTarget,
        avgRedCards: homeTeamStats.avgRedCards,
      },
      {
        ...
        avgShots: awayTeamStats.avgShots,
        avgShotsOnTarget: awayTeamStats.avgShotsOnTarget,
        avgRedCards: awayTeamStats.avgRedCards,
      },
      odds,
      period,
      statsQuality,
